...
<head>
    ...
    <title>Mastère ESI - Big Data & IA | ESICIM</title>
        ...
        <div class="container">
            <div class="two-column-section"> 
                ...
                <div class="text-content">
                    ...
                    <p>Le Mastère ESI - Big Data & IA vous plonge au cœur de la révolution des données. Ce cursus de haut niveau est conçu pour vous permettre d'explorer le potentiel des données massives et de l'intelligence artificielle pour créer des systèmes intelligents et prédictifs. Vous apprendrez à collecter, stocker et traiter des volumes massifs de données, à développer des modèles de machine learning performants et à transformer les informations brutes en décisions stratégiques pour l'entreprise.</p>
                    <br>
                    <h4>OBJECTIFS DE LA FORMATION</h4>
                    <ul class="list-styled">
                        <li>Concevoir et gérer des architectures Big Data (Hadoop, Spark)</li>
                        <li>Développer et déployer des modèles de Machine Learning et Deep Learning</li>
                        <li>Maîtriser les outils de Data Visualisation pour communiquer les résultats</li>
                        <li>Piloter des projets data de la collecte à l'industrialisation (MLOps)</li>
                        <li>Comprendre les enjeux éthiques et juridiques liés à l'IA et à la donnée</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="diplome-validation-grid">
                <div class="diplome-card">
                    ...
                    <div class="rncp-cert-tag">LA CERTIFICATION RNCP38628</div> 
                    <img src="photos/SITE-ESICIM-59.png" alt="Image Diplôme 1" class="card-content-image">
                    <h4>BAC+5 MASTÈRE ESI BIG DATA & IA</h4>
                    <p>Expert en Science des Données et IA</p>
                ...
                <div class="validation-card">
                    ...
                    <p>La validation de la formation se fait par l’acquisition de l’ensemble des compétences analytiques et techniques visées par la certification. Elles sont organisées en 5 blocs de compétences :</p>
                    <ul class="list-styled">
                        <li><b>BC01 :</b> Ingénierie et Architecture Big Data</li>
                        <li><b>BC02 :</b> Machine Learning et Modélisation Prédictive</li>
                        <li><b>BC03 :</b> Deep Learning et Intelligence Artificielle</li>
                        <li><b>BC04 :</b> Data Visualisation et Stratégie Data-Driven</li>
                        <li><b>BC05 :</b> Gestion de Projet IA et Éthique de la Donnée</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="two-column-section image-left" style="margin-bottom: 60px;">
                <div class="text-content">
                    ...
                    <ul class="list-styled">
                        ...
                        <li>Data Analyst</li>
                        <li>Ingénieur / Ingénieure Big Data</li>
                        <li>Ingénieur / Ingénieure Machine Learning (MLOps)</li>
                        <li>Architecte Data</li>
                        <li>Chef de projet IA / Data</li>
                    </ul>
                </div>
                <div class="image-content">
            ...
            <div class="programme-grid">
                <div class="programme-col">
                    <h4>Spécialité Big Data & IA</h4>
                    <ul class="list-styled">
                        <li>Écosystème Hadoop & Spark</li>
                        <li>Bases de données NoSQL</li>
                        <li>Algorithmes de Machine Learning (Scikit-learn)</li>
                        <li>Réseaux de neurones et Deep Learning (TensorFlow, PyTorch)</li>
                        <li>Traitement du langage naturel (NLP)</li>
                        <li>Computer Vision</li>
                        <li>Plateformes Cloud pour l'IA (AWS, Azure, GCP)</li>
    ...
    <section class="section-padding">
        <div class="container">
            ...
            <p style="text-align: center; margin-bottom: 30px;">
                BAC+5 MASTÈRE ESI - BIG DATA & IA<br>
                Titre d'Expert en Science des Données et IA<br>

...
<head>
    ...
    <title>BTS SAM - Support à l'Action Managériale | ESICIM</title>
        ...
        <div class="container">
            <div class="two-column-section"> 
                ...
                <div class="text-content">
                    ...
                    <p>Le BTS Support à l'Action Managériale (SAM) forme des professionnels polyvalents, capables d'assister un ou plusieurs managers au quotidien. Vous deviendrez le bras droit d'un responsable en optimisant les processus administratifs et en gérant des projets complexes. Ce rôle central nécessite des compétences en organisation, communication, gestion et une maîtrise des outils numériques pour assurer l'efficacité et la performance de l'équipe ou du service.</p>
                    <br>
                    <h4>OBJECTIFS DE LA FORMATION</h4>
                    <ul class="list-styled">
                        <li>Optimiser les processus administratifs et la gestion des ressources</li>
                        <li>Gérer des projets et des dossiers complexes de A à Z</li>
                        <li>Assurer une communication professionnelle, en français et en langues étrangères</li>
                        <li>Collaborer activement à la gestion des ressources humaines</li>
                        <li>Maîtriser les outils numériques et collaboratifs pour améliorer la performance</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="diplome-validation-grid">
                <div class="diplome-card">
                    ...
                    <div class="rncp-cert-tag">LA CERTIFICATION RNCP34030</div> 
                ...
                <div class="validation-card">
                    ...
                    <p>La validation de la formation est sanctionnée par le passage de l'examen national du BTS SAM, qui repose sur des épreuves écrites, orales et pratiques, ainsi que sur les résultats obtenus en contrôle en cours de formation (CCF).</p>
                    <ul class="list-styled">
                        <li><b>Bloc 1 :</b> Optimisation des processus administratifs</li>
                        <li><b>Bloc 2 :</b> Gestion de projet</li>
                        <li><b>Bloc 3 :</b> Collaboration à la gestion des ressources humaines</li>
                        <li><b>Bloc 4 :</b> Culture générale et expression</li>
                        <li><b>Bloc 5 :</b> Langues vivantes étrangères (A et B)</li>
                        <li><b>Bloc 6 :</b> Culture économique, juridique et managériale</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="two-column-section image-left" style="margin-bottom: 60px;">
                <div class="text-content">
                    ...
                    <ul class="list-styled">
                        <li>Assistant / Assistante de direction</li>
                        <li>Office Manager</li>
                        <li>Assistant / Assistante de projet</li>
                        <li>Assistant / Assistante en ressources humaines</li>
                        <li>Chargé / Chargée de recrutement</li>
                        <li>Assistant / Assistante commerciale</li>
                        <li>Coordinateur / Coordinatrice administratif(ve)</li>
                    </ul>
                </div>
                <div class="image-content">
            ...
            <div class="programme-grid">
                <div class="programme-col">
                    ...
                    <ul class="list-styled">
                        ...
                        <li>Collaboration à la gestion des RH</li>
    ...
    <section class="section-padding">
        <div class="container">
            ...
            <p style="text-align: center; margin-bottom: 30px;">
                BAC+2 BTS - SUPPORT À L'ACTION MANAGÉRIALE<br>

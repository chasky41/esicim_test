...
<head>
    ...
    <title>Master - Chef de Projet Digital | ESICIM</title>
            ...
            <div class="info-grid-sio">
                <div class="info-card">
                    ...
                    <ul>
                        ...
                        <li>(Marketing, Communication, Digital, IT...)</li>
                    </ul>
                </div>
                <div class="info-card">
        ...
        <div class="container">
            <div class="two-column-section">
                ...
                <div class="text-content">
                    ...
                    <p>Le Master Chef de Projet Digital forme des professionnels capables de piloter des projets web et mobiles de A à Z. Véritable chef d'orchestre, vous apprendrez à coordonner les équipes techniques, créatives et marketing, à maîtriser le budget et à définir la stratégie digitale. Ce cursus vous prépare à gérer des projets complexes en utilisant les méthodologies Agiles (Scrum, Kanban) pour garantir la livraison de produits et services numériques performants, dans le respect des délais et des coûts.</p>
                    <br>
                    <h4>OBJECTIFS DE LA FORMATION</h4>
                    <ul class="list-styled">
                        <li>Maîtriser les méthodologies de gestion de projet (Agile, Scrum, cycle en V)</li>
                        <li>Cadrer un projet digital : définition des besoins, cahier des charges, budget</li>
                        <li>Piloter et coordonner des équipes pluridisciplinaires (UX/UI, Dev, Marketing)</li>
                        <li>Assurer le suivi de la qualité, des délais et des coûts du projet</li>
                        <li>Définir et suivre les indicateurs de performance (KPIs) d'un projet digital</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="diplome-validation-grid">
                <div class="diplome-card">
                    ...
                    <div class="rncp-cert-tag">LA CERTIFICATION RNCP37333</div>
                    <img src="photos/SITE-ESICIM-59.png" alt="Image Diplôme 1" class="card-content-image">
                    <h4>BAC+5 MASTER</h4>
                    <p>MANAGER DE PROJETS NUMÉRIQUES ET STRATÉGIE DIGITALE</p>
                ...
                <div class="validation-card">
                    ...
                    <p>La validation est obtenue par la réussite aux évaluations des blocs de compétences, la gestion d'un projet d'envergure et une soutenance finale devant un jury de professionnels.</p>
                    <ul class="list-styled">
                        <li><b>BC01 :</b> Cadrage et conception de projets digitaux</li>
                        <li><b>BC02 :</b> Pilotage et gestion des ressources du projet (Agile/Scrum)</li>
                        <li><b>BC03 :</b> Management d'équipe et communication projet</li>
                        <li><b>BC04 :</b> Gestion de la relation client et des parties prenantes</li>
                        <li><b>BC05 :</b> Élaboration de la stratégie digitale associée au projet</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="two-column-section image-left" style="margin-bottom: 60px;">
                <div class="text-content">
                    ...
                    <ul class="list-styled">
                        <li>Chef de projet digital / web / mobile</li>
                        <li>Product Owner</li>
                        <li>Scrum Master</li>
                        <li>Consultant / Consultante en transformation digitale</li>
                        <li>Responsable de pôle digital</li>
                        <li>Traffic Manager / Responsable acquisition</li>
                    </ul>
                </div>
                <div class="image-content">
            ...
            <div class="programme-grid">
                <div class="programme-col">
                    <h4>1ÈRE ANNÉE : FONDAMENTAUX DU DIGITAL</h4>
                    <ul class="list-styled">
                        <li>Gestion de projet (Méthodes Agiles)</li>
                        <li>Marketing digital (SEO, SEA, Contenu)</li>
                        <li>UX/UI Design & Ergonomie</li>
                        <li>Fondamentaux techniques du web</li>
                        <li>Gestion budgétaire et financière</li>
                        <li>Droit du numérique et RGPD</li>
                    </ul>
                </div>
                <div class="programme-col">
                    <h4>2ÈME ANNÉE : MANAGEMENT DE PROJET AVANCÉ</h4>
                    <ul class="list-styled">
                        <li>Management avancé (Scrum, Kanban)</li>
                        <li>Stratégie de produit (Product Ownership)</li>
                        <li>Management d'équipe et leadership</li>
                        <li>Data Analytics & Suivi des KPIs</li>
                        <li>Gestion de la relation client (CRM)</li>
                        <li>Mémoire professionnel et soutenance</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding">
        <div class="container">
            ...
            <p style="text-align: center; margin-bottom: 30px;">
                BAC+5 MASTER - CHEF DE PROJET DIGITAL<br>
                MANAGER DE PROJETS NUMÉRIQUES ET STRATÉGIE DIGITALE<br>

...
<head>
    ...
    <title>Master - Business Developer IT | ESICIM</title>
            ...
            <div class="info-grid-sio">
                <div class="info-card">
                    ...
                    <ul>
                        ...
                        <li>(Commerce, Management, Informatique...)</li>
                    </ul>
                </div>
                <div class="info-card">
        ...
        <div class="container">
            <div class="two-column-section">
                ...
                <div class="text-content">
                    ...
                    <p>Le Master Business Developer IT est une formation de haut niveau destinée aux profils hybrides qui souhaitent faire le lien entre la technique et le commerce. Vous y apprendrez à maîtriser la vente de solutions et services technologiques complexes (SaaS, Cloud, IA, Cybersécurité). Ce cursus vous donnera les clés pour comprendre les besoins techniques des clients, construire des offres sur-mesure et piloter des cycles de vente longs et stratégiques dans le secteur de l'innovation.</p>
                    <br>
                    <h4>OBJECTIFS DE LA FORMATION</h4>
                    <ul class="list-styled">
                        <li>Comprendre les enjeux techniques des solutions IT (Cloud, SaaS, Cybersécurité)</li>
                        <li>Maîtriser le cycle de vente complexe de la prospection au closing</li>
                        <li>Élaborer des propositions commerciales techniques et financières sur-mesure</li>
                        <li>Gérer des portefeuilles de grands comptes dans le secteur de la tech</li>
                        <li>Développer une double compétence technique et commerciale très recherchée</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="diplome-validation-grid">
                <div class="diplome-card">
                    ...
                    <div class="rncp-cert-tag">LA CERTIFICATION RNCP37222</div>
                    <img src="photos/SITE-ESICIM-59.png" alt="Image Diplôme 1" class="card-content-image">
                    <h4>BAC+5 MASTER</h4>
                    <p>MANAGER EN INGÉNIERIE D'AFFAIRES TECHNOLOGIQUES</p>
                ...
                <div class="validation-card">
                    ...
                    <p>La validation est obtenue par la réussite aux évaluations des blocs de compétences, la réalisation d'un projet de développement d'affaires technologique et une soutenance finale.</p>
                    <ul class="list-styled">
                        <li><b>BC01 :</b> Analyse des marchés technologiques et stratégie de développement</li>
                        <li><b>BC02 :</b> Ingénierie d'affaires et vente de solutions complexes</li>
                        <li><b>BC03 :</b> Gestion de projet et management de comptes stratégiques</li>
                        <li><b>BC04 :</b> Pilotage de la performance commerciale dans l'IT</li>
                        <li><b>BC05 :</b> Culture technologique et veille stratégique</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="two-column-section image-left" style="margin-bottom: 60px;">
                <div class="text-content">
                    ...
                    <ul class="list-styled">
                        <li>Ingénieur d'affaires IT / Ingénieur commercial</li>
                        <li>Business Developer (SaaS, ESN, Editeur de logiciel)</li>
                        <li>Responsable grands comptes IT (Key Account Manager)</li>
                        <li>Sales Engineer / Avant-vente</li>
                        <li>Responsable de partenariats technologiques (Alliance Manager)</li>
                        <li>Consultant / Consultante en transformation numérique</li>
                    </ul>
                </div>
                <div class="image-content">
            ...
            <div class="programme-grid">
                <div class="programme-col">
                    <h4>1ÈRE ANNÉE : FONDAMENTAUX TECH & COMMERCE</h4>
                    <ul class="list-styled">
                        <li>Fondamentaux des SI (Réseaux, Cloud, Data)</li>
                        <li>Techniques de vente B2B</li>
                        <li>Marketing de l'innovation</li>
                        <li>Gestion de projet Agile</li>
                        <li>Droit de l'informatique et des contrats</li>
                        <li>Négociation commerciale</li>
                    </ul>
                </div>
                <div class="programme-col">
                    <h4>2ÈME ANNÉE : EXPERTISE EN VENTE IT</h4>
                    <ul class="list-styled">
                        <li>Vente de solutions SaaS & Cloud</li>
                        <li>Stratégie de réponse aux appels d'offres</li>
                        <li>Management des grands comptes IT</li>
                        <li>Marketing des services technologiques</li>
                        <li>Financement de projets IT</li>
    ...
    <section class="section-padding">
        <div class="container">
            ...
            <p style="text-align: center; margin-bottom: 30px;">
                BAC+5 MASTER - BUSINESS DEVELOPER IT<br>
                MANAGER EN INGÉNIERIE D'AFFAIRES TECHNOLOGIQUES<br>

...
<head>
    ...
    <title>Licence RCM - Responsable Commercial & Marketing | ESICIM</title>
        ...
        <div class="container">
            <div class="info-grid-sio">
                <div class="info-card">
                    ...
                    <ul>
                        <li>Titulaires d’un Bac+2 validé</li>
                        <li>(BTS, DUT/BUT2, Licence 2...)</li>
                        <li>Spécialités : Commerce, Vente, Gestion, Marketing...</li>
                    </ul>
                </div>
                <div class="info-card">
        ...
        <div class="container">
            <div class="two-column-section">
                ...
                <div class="text-content">
                    ...
                    <p>La Licence Responsable Commercial & Marketing (RCM) est une formation intensive d'un an conçue pour les titulaires d'un Bac+2. Elle permet de vous spécialiser et d'acquérir une expertise approfondie en stratégies marketing et commerciales. Ce programme vous prépare à des postes à responsabilités en vous dotant des compétences nécessaires pour piloter des projets, manager une équipe et développer activement le chiffre d'affaires de l'entreprise.</p>
                    <br>
                    <h4>OBJECTIFS DE LA FORMATION</h4>
                    <ul class="list-styled">
                        <li>Approfondir sa maîtrise de la stratégie commerciale et marketing</li>
                        <li>Apprendre à manager et animer une équipe de vente</li>
                        <li>Piloter des campagnes marketing omnicanales</li>
                        <li>Analyser les indicateurs de performance (KPIs) et optimiser les actions</li>
                        <li>Développer une expertise en négociation et gestion de la relation client</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="diplome-validation-grid">
                <div class="diplome-card">
                    ...
                    <div class="rncp-cert-tag">LA CERTIFICATION RNCP34130</div>
                    <img src="photos/SITE-ESICIM-59.png" alt="Image Diplôme 1" class="card-content-image">
                    <h4>BAC+3 LICENCE RCM</h4>
                    <p>RESPONSABLE COMMERCIAL & MARKETING</p>
                ...
                <div class="validation-card">
                    ...
                    <p>La validation de la formation est basée sur l'acquisition de compétences clés, évaluées par des études de cas, des projets professionnels et des soutenances orales. Elle est organisée en 4 blocs de compétences :</p>
                    <ul class="list-styled">
                        <li><b>BC01 :</b> Définition de la stratégie commerciale et marketing</li>
                        <li><b>BC02 :</b> Pilotage et mise en œuvre du plan d'actions commerciales</li>
                        <li><b>BC03 :</b> Conception et déploiement d'actions marketing</li>
                        <li><b>BC04 :</b> Management d'une équipe et suivi des performances</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="two-column-section image-left" style="margin-bottom: 60px;">
                <div class="text-content">
                    ...
                    <ul class="list-styled">
                        <li>Responsable commercial et marketing</li>
                        <li>Chef de secteur / Responsable des ventes</li>
                        <li>Chargé / Chargée de marketing opérationnel</li>
                        <li>Business Developer</li>
                        <li>Responsable de la relation client (CRM)</li>
            ...
            <div class="programme-grid">
                ...
                <div class="programme-col">
                    <h4>MARKETING & VENTE</h4>
                    <ul class="list-styled">
                        <li>Marketing digital (SEO, SEA, Social Media)</li>
                        <li>Négociation complexe et grands comptes</li>
                        <li>Marketing B2B</li>
                        <li>Communication et plan média</li>
                        <li>Projet professionnel tutoré</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding">
        <div class="container">
            ...
            <p style="text-align: center; margin-bottom: 30px;">
                BAC+3 LICENCE RCM<br>
                RESPONSABLE COMMERCIAL & MARKETING<br>

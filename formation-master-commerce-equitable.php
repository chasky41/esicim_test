...
<head>
    ...
    <title>Master - Commerce Équitable & International | ESICIM</title>
            ...
            <div class="info-grid-sio">
                <div class="info-card">
                    ...
                    <ul>
                        ...
                        <li>(Licence, Bachelor...)</li>
                        <li>Spécialités : Commerce Int., Économie, RSE...</li>
                    </ul>
                </div>
                <div class="info-card">
        ...
        <div class="container">
            <div class="two-column-section">
                ...
                <div class="text-content">
                    ...
                    <p>Le Master en Commerce Équitable & International est une formation de pointe pour les futurs leaders d'un commerce plus juste et durable. Ce programme vous permet de vous spécialiser dans les échanges internationaux éthiques pour générer un impact positif. Vous apprendrez à construire des chaînes d'approvisionnement responsables, à travailler avec les labels et certifications, et à développer des stratégies commerciales qui allient performance économique et responsabilité sociale et environnementale.</p>
                    <br>
                    <h4>OBJECTIFS DE LA FORMATION</h4>
                    <ul class="list-styled">
                        <li>Analyser les enjeux du commerce international sous l'angle du développement durable</li>
                        <li>Maîtriser les certifications et les labels du commerce équitable (Fair Trade, etc.)</li>
                        <li>Construire et gérer des chaînes d'approvisionnement éthiques et responsables</li>
                        <li>Développer des stratégies commerciales intégrant des critères sociaux et environnementaux</li>
                        <li>Piloter des projets à impact positif dans un contexte international</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="diplome-validation-grid">
                <div class="diplome-card">
                    ...
                    <div class="rncp-cert-tag">LA CERTIFICATION RNCP37111</div>
                    <img src="photos/SITE-ESICIM-59.png" alt="Image Diplôme 1" class="card-content-image">
                    <h4>BAC+5 MASTER</h4>
                    <p>MANAGER DU DÉVELOPPEMENT COMMERCIAL DURABLE À L'INTERNATIONAL</p>
                ...
                <div class="validation-card">
                    ...
                    <p>La validation est obtenue par la réussite aux évaluations des différents blocs de compétences, la rédaction d'un mémoire de recherche appliquée et une soutenance finale devant un jury.</p>
                    <ul class="list-styled">
                        <li><b>BC01 :</b> Analyse des marchés internationaux et des enjeux du commerce durable</li>
                        <li><b>BC02 :</b> Ingénierie de projets de commerce équitable et responsable</li>
                        <li><b>BC03 :</b> Management des chaînes d'approvisionnement éthiques</li>
                        <li><b>BC04 :</b> Stratégie marketing et commerciale pour les produits à impact</li>
                        <li><b>BC05 :</b> Pilotage de la performance RSE et des partenariats internationaux</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="two-column-section image-left" style="margin-bottom: 60px;">
                <div class="text-content">
                    ...
                    <ul class="list-styled">
                        <li>Chef de produit commerce équitable</li>
                        <li>Responsable RSE (Responsabilité Sociale des Entreprises)</li>
                        <li>Responsable des achats durables / Sourcing éthique</li>
                        <li>Chef de projet en ONG / Association de commerce équitable</li>
                        <li>Responsable import/export spécialisé filières durables</li>
                        <li>Consultant / Consultante en commerce international et durable</li>
                    </ul>
                </div>
                <div class="image-content">
            ...
            <div class="programme-grid">
                <div class="programme-col">
                    <h4>1ÈRE ANNÉE : FONDAMENTAUX</h4>
                    <ul class="list-styled">
                        <li>Géopolitique et commerce international</li>
                        <li>Principes du développement durable et de la RSE</li>
                        <li>Droit du commerce international</li>
                        <li>Logistique et Supply Chain durable</li>
                        <li>Marketing interculturel</li>
                        <li>Gestion de projet à impact</li>
                    </ul>
                </div>
                <div class="programme-col">
                    <h4>2ÈME ANNÉE : EXPERTISE</h4>
                    <ul class="list-styled">
                        <li>Stratégies du commerce équitable</li>
                        <li>Labels et certifications (Fair Trade, Bio)</li>
                        <li>Achats et sourcing responsables</li>
                        <li>Financement de projets à impact social</li>
                        <li>Marketing des produits éthiques</li>
                        <li>Mémoire de recherche appliquée</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding">
        <div class="container">
            ...
            <p style="text-align: center; margin-bottom: 30px;">
                BAC+5 MASTER - COMMERCE ÉQUITABLE & INTERNATIONAL<br>
                MANAGER DU DÉVELOPPEMENT COMMERCIAL DURABLE À L'INTERNATIONAL<br>

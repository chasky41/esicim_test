...
<head>
    ...
    <title>Licence RDC - Responsable du Développement Commercial | ESICIM</title>
            ...
            <div class="info-grid-sio">
                <div class="info-card">
                    ...
                    <ul>
                        ...
                        <li>Spécialités : Vente, Commerce, Négociation...</li>
                    </ul>
                </div>
                <div class="info-card">
        ...
        <div class="container">
            <div class="two-column-section">
                ...
                <div class="text-content">
                    ...
                    <p>La Licence Responsable du Développement Commercial (RDC) est une année intensive pour devenir un pro de la négociation et du développement d'affaires sur des marchés complexes. Destinée aux titulaires d'un Bac+2, cette spécialisation vous permet d'accéder rapidement à des postes stratégiques en vous formant à la gestion de grands comptes, à la réponse aux appels d'offres et au pilotage de la performance commerciale.</p>
                    <br>
                    <h4>OBJECTIFS DE LA FORMATION</h4>
                    <ul class="list-styled">
                        <li>Développer une expertise en stratégie de conquête de marchés complexes</li>
                        <li>Maîtriser les cycles de vente longs et la négociation de haut niveau</li>
                        <li>Piloter le développement d'un portefeuille de grands comptes</li>
                        <li>Structurer et présenter des offres commerciales à forte valeur ajoutée</li>
                        <li>Analyser la performance pour optimiser la stratégie de développement</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="programme-grid">
                <div class="programme-col">
                    <h4>STRATÉGIE & DÉVELOPPEMENT</h4>
                    <ul class="list-styled">
                        <li>Stratégie de développement commercial</li>
                        <li>Intelligence économique et veille</li>
                        <li>Management des grands comptes</li>
                        <li>Marketing B2B et génération de leads</li>
                        <li>Gestion de projet commercial</li>
                    </ul>
                </div>
                <div class="programme-col">
                    <h4>TECHNIQUES & NÉGOCIATION</h4>
                    <ul class="list-styled">
                        <li>Techniques de négociation complexe</li>
                        <li>Réponse aux appels d'offres</li>
                        <li>Ingénierie d'affaires</li>
                        <li>Closing et techniques de conclusion</li>
                        <li>Pilotage de la performance (CRM & KPIs)</li>
                    </ul>
                </div>
            </div>
        </div>

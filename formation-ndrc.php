...
<head>
    ...
    <title>BTS NDRC - Négociation et Digitalisation de la Relation Client | ESICIM</title>
...
<div class="sio-page-container">
    ...
    <section class="competences-box">
        <div class="container">
            ...
            <p>Un commercial généraliste qui met en œuvre une stratégie commerciale et marketing an de nouer une relation de proximité avec le client, il gère de multiples points de contacts.</p>
        ...
        <div class="container">
            <div class="two-column-section">
                <div class="text-content">
                    ...
                    <p>Le BTS – Négociation et Digitalisation de la Relation Client est un diplôme d’état de niveau 5 - BAC+2, délivré par le ministère de l’enseignement supérieur. Le titulaire du BTS NDRC est un commercial généraliste expert de la relation client considérée sous toutes ses formes (en présentiel, à distance, e-relation) et dans toute sa complexité. Il communique et négocie avec les clients, exploite et partage les informations, organise et planifie l'activité, met en œuvre la politique commerciale. Il contribue ainsi à la croissance du chiffre d'affaires de l'entreprise.</p>
                    <p>En lien direct avec le client, le titulaire du BTS NDRC est un vecteur de communication interne et externe. Il intervient également dans la chaine de valeur de ses clients pour favoriser leur développement. Il porte les valeurs et la culture de l’organisation pour son propre compte ou celui d’un commanditaire. Il est capable de s’adapter aux exigences de son activité et réalise ses missions dans le respect des règles éthiques et déontologiques. Dans une constante relation client, il assure les fonctions de prospection de clientèle, de négociation-vente et d’animation de réseaux. Il maîtrise la relation client et développe la relation client en e-commerce. Il développe et pilote un réseau de partenaires et anime un réseau de vente.</p>
                    <br>
                    <h4>OBJECTIFS DE LA FORMATION</h4>
                    <ul class="list-styled">
                        <li>Gère la relation client dans sa globalité, de la prospection jusqu’à la fidélisation, et contribue ainsi à la croissance profitable du chiffre d’affaires compatible avec une optique de développement durable.</li>
                        <li>S’inscrire dans un contexte de mutation des métiers commerciaux sous les effets conjugués de l’élévation du degré d’exigence du consommateur, de l’ouverture des marchés et des évolutions technologiques.</li>
                        <li>S’inscrire son activité dans une logique de réseau en privilégiant le travail coopératif.</li>
                        <li>Participe à l’intelligence commerciale de l’organisation et contribue à l’efficacité de la politique commerciale.</li>
                    </ul>
                </div>
    ...
    <div class="container">
        <div class="diplome-validation-grid">
            <div class="diplome-card">
                ...
                <h4>BAC+2 BTS NDRC EN 2 ANS</h4>
                <p>NÉGOCIATION ET LA DIGITALISATION DE LA RELATION CLIENT</p>
            ...
            <div class="validation-card">
                ...
                <p>La validation de la formation se fait par l’acquisition de l’ensemble des compétences techniques et relationnelles visées par la certification. Elles sont organisées en 3 blocs de compétences :</p>
                <ul class="list-styled">
                    <li><b>BC01 :</b> Relation client et négociation-vente</li>
                    <li><b>BC02 :</b> Relation client à distance et digitalisation</li>
                    <li><b>BC03 :</b> Relation client et animation de réseaux</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="programme-grid">
                <div class="programme-col">
                    ...
                    <ul class="list-styled">
                        ...
                        <li>Organiser et animer un événement commercial</li>
                        <li>Exploiter et mutualiser l’information commerciale</li>
                        <li>Relation client à distance et digitalisation</li>
                        <li>Maîtriser la relation omnicanale</li>
                        <li>Animer la relation client digitale</li>
                        <li>Développer la relation client en e -commerce</li>
                        <li>Relation client et animation de réseaux</li>
                        <li>Implanter et promouvoir l’offre chez des distributeurs</li>
                        <li>Développer et animer un réseau de partenaires</li>
                        <li>Créer et animer un réseau de vente directe</li>
                    </ul>
                </div>
                <div class="programme-col">
    ...
    <section class="section-padding">
        <div class="container">
            ...
            <p style="text-align: center; margin-bottom: 30px;">
                BAC+2 BTS NDRC EN 2 ANS<br>
                NÉGOCIATION ET LA DIGITALISATION DE LA RELATION CLIENT<br>

            ...
            <div class="two-column-section">
                ...
                <div class="text-content">
                    ...
                    <ul class="list-styled">
                        ...
                        <li>Construire et piloter une stratégie de développement commercial</li>
        ...
        <div class="container">
            <div class="diplome-validation-grid">
                ...
                <div class="validation-card">
                    ...
                    <ul class="list-styled">
                        <li><b>BC01 :</b> Élaboration du plan de développement commercial</li>
                        <li><b>BC02 :</b> Mise en oeuvre d’une stratégie de prospection</li>
                        <li><b>BC03 :</b> Négociation d’une offre commerciale</li>
                        <li><b>BC04 :</b> Management de l’activité commerciale</li>
                    </ul>
                </div>
            </div>
        </div>
